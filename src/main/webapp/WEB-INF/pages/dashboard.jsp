...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Kütüphane Projesi</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="alert bg-primary" role="alert">
					<svg class="glyph stroked empty-message"><use xlink:href="#stroked-empty-message"></use></svg> EMNÝYET GENEL MÜDÜRLÜÐÜ KÜTÜPHANE PROJESÝNE HOÞGELDÝNÝZ!
				</div>
			</div>
		</div><!--/.row-->		
